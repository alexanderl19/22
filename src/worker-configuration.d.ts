/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 90dea9a1eb38da3f47dd42945a23fd60)
// Runtime types generated with workerd@1.20251113.0 2025-11-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DEV_AUTH_REDIRECT_URL: string;
		...
		AUTH_API: Fetcher /* auth-api */;
		AUTH_REDIRECT: Fetcher /* auth-redirect */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_AUTH_REDIRECT_URL" | "AUTH_API_BASE_URL" | "PUBLIC_AUTH_BASE_URL" | "PUBLIC_BASE_URL" | "DEV_DATABASE_URL" | "ELECTRIC_SOURCE_ID" | "ELECTRIC_SECRET" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
